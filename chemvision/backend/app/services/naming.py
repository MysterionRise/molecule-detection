...
def name_to_smiles(name: str) -> str | type[NotImplemented]:
    ...
    Phase 1: Returns SMILES only for demo mappings, NotImplemented otherwise.
    ...
    Returns:
        SMILES string if conversion successful, NotImplemented otherwise
    """
...
def smiles_to_name(smiles: str) -> str | type[NotImplemented]:
    ...
    Returns:
        IUPAC name if conversion successful, NotImplemented otherwise
    """
